...
data class BleThroughputSample(
    val totalBytes: Long,
...
data class BleBidirectionalThroughputSample(
    val txBytes: Long,
    val rxBytes: Long,
    val elapsedMillis: Long,
...
data class BleThroughputStats(
    val totalBytes: Long = 0,
    val elapsedMillis: Long = 0,
    val intervalBytes: Long = 0,
    val intervalMillis: Long = 0,
) {
    constructor(sample: BleThroughputSample) : this(
...
data class BleBidirectionalThroughputStats(
    val txBytes: Long = 0,
    val rxBytes: Long = 0,
    val elapsedMillis: Long = 0,
    ...
    constructor(sample: BleBidirectionalThroughputSample) : this(
